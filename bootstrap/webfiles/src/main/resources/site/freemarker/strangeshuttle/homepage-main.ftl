...
<!--Hero-->
<section id="hero" class="module-hero bg-dark-30 js-fullheight" data-background="<@hst.webfile path="/images/module-1.jpg" />" />

  <!-- HERO TEXT -->
  <div class="hero-caption">
    <div class="hero-text">
      <h6 class="m-b-30">content</h6>
      <h1 class="m-b-30">${title?html}</h1>
      <h6 class="m-b-60">${text?html}</h6>
				...
				<div class="works-grid-wrapper">
					...
					<div id="works-grid" class="works-grid works-grid-gutter">
						...
						<article class="work-item travel video">
							<div class="work-wrapper">
								<div class="work-thumbnail">
									<img src="<@hst.webfile path="/images/portfolio-1.jpg" />" alt="" />
								</div>
						...
						<article class="work-item fashion">
							<div class="work-wrapper">
								<div class="work-thumbnail">
									<img src="<@hst.webfile path="/images/portfolio-8.jpg" />" alt="" />
								</div>
								<div class="work-caption">
						...
						<article class="work-item music">
							<div class="work-wrapper">
								<div class="work-thumbnail">
									<img src="<@hst.webfile path="/images/portfolio-2.jpg" />" alt="" />
								</div>
								<div class="work-caption">
						...
						<article class="work-item fashion">
							<div class="work-wrapper">
								<div class="work-thumbnail">
									<img src="<@hst.webfile path="/images/portfolio-3.jpg" />" alt="" />
								</div>
								<div class="work-caption">
						...
						<article class="work-item travel">
							<div class="work-wrapper">
								<div class="work-thumbnail">
									<img src="<@hst.webfile path="/images/portfolio-4.jpg" />" alt="" />
								</div>
								<div class="work-caption">
						...
						<article class="work-item music">
							<div class="work-wrapper">
								<div class="work-thumbnail">
									<img src="<@hst.webfile path="/images/portfolio-5.jpg" />" alt="" />
								</div>
								<div class="work-caption">
						...
						<article class="work-item travel">
							<div class="work-wrapper">
								<div class="work-thumbnail">
									<img src="<@hst.webfile path="/images/portfolio-6.jpg" />" alt="" />
								</div>
								<div class="work-caption">
						...
						<article class="work-item fashion">
							<div class="work-wrapper">
								<div class="work-thumbnail">
									<img src="<@hst.webfile path="/images/portfolio-7.jpg" />" alt="" />
								</div>
								<div class="work-caption">
